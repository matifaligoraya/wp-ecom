...
class WordPressApi {
  ...
  String _getOAuthURL(String requestMethod, String endpoint) {
    ...
    String token = "";
    String url = "${this.url}/wp-json/wp/v2/$endpoint";
    ...
    String parameters = "oauth_consumer_key=$consumerKey&oauth_nonce=$nonce&oauth_signature_method=HMAC-SHA1&oauth_timestamp=$timestamp&oauth_token=$token&oauth_version=1.0&";
    ...
    String baseString = "$method&${Uri.encodeQueryComponent(
